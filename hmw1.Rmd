...
=======
##
>>>>>>> 4b544f130301b08e5cf29675c28e2a5a7e577344
...
=======
   p<-ggplot(draws_probs_new2,aes(x=predictor,shape=draws_probs_new2$bin))+geom_point(aes(y=classical_prob))+geom_point(aes(y=actual_prob,),col="blue")+ scale_shape_identity() +xlab("P(home win) – P(away win win)")+ylab("P(1/odd)")+ggtitle(paste(pl_betters[i],"-",count,"match removed",sep=" "))
>>>>>>> 4b544f130301b08e5cf29675c28e2a5a7e577344
  plot(p)
}
